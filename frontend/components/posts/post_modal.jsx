...
class PostModal extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      Array.isArray(this.props.modal)
    ) {
      this.setState({
        body: this.props.modal[2],
        imageUrl: this.props.modal[3],
      });
    }
  }
  ...
  render() {
    ...
    return (
      ...
      >
        <div
          id="profile-pic-modal-container"
        ...
        >
          <div className="post-modal">
            ...
            <button
              disabled={this.state.body.length ? false : true}
