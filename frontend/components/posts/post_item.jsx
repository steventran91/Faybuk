  ...
  render() {
    ...
    return (
      <li className="post-item">
        <div className="post-item-header">
          <div>
            <div className="prof-pic-thumb-small">
              <img src={this.props.author.profile_pic}></img>
            </div>
            <div className="post-item-meta">
              <div>
                <Link to={`/users/${this.props.author.id}`}>
                  <div>{`${this.props.author.first_name} ${this.props.author.last_name}`}</div>
                </Link>
                {this.props.author.id === this.props.wallUser.id ? (
                  ...
                  <>
                    ...
                    <Link to={`/users/${this.props.wallUser.id}`}>
                      <div>{`${this.props.wallUser.first_name} ${this.props.wallUser.last_name}`}</div>
                    </Link>
                  </>
                )}
              </div>
        ...
        <ul className="comment-list">{commentArr}</ul>
