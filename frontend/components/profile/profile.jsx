...
import {
  getFriendships,
  getFriends,
} from "../../reducers/selectors/friendship_selectors";
import {
  getOutgoingFriendRequests,
  getIncomingFriendRequests,
} from "../../reducers/selectors/friend_request_selectors";
...
const mSTP = (state, ownProps) => {
  return {
    ...
    myPendingRequests: getOutgoingFriendRequests(
      state.entities.friendRequests,
      state.session.currentUser
    ),
    myIncomingRequests: getIncomingFriendRequests(
      state.entities.friendRequests,
      state.session.currentUser
    ),
...
class Profile extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.match.params.userId !== prevProps.match.params.userId) {
      this.props
        ...
        .then(this.setState({ page: "timeline" }));
    }
  }
  ...
  render() {
    ...
    if (this.state.page === "timeline") {
      renderedPage = (
        <Timeline user={this.props.user} currentUser={this.props.currentUser} />
      );
    ...
    if (this.props.errors.length) {
      ...
      return (
        <div className="profile-page">
          ...
          <div className="profile-nav-container">
            <div className="profile-nav-bar">
              <div className="profile-nav-links">
                <div
                  className={
                    this.state.page === "timeline" ? "active-profile-page" : ""
                  }
                ...
                <div
                  className={
                    this.state.page === "about" ? "active-profile-page" : ""
                  }
                  onClick={this.handlePageToRender("about")}
                >
                  <p>About</p>
                ...
                <div
                  className={
                    this.state.page === "friends" ? "active-profile-page" : ""
                  }
                ...
                <div
                  className={
                    this.state.page === "photos" ? "active-profile-page" : ""
                  }
          ...
          <div className="profile-main">{renderedPage}</div>
        </div>
      );
    }
  }
