...
class CoverPhoto extends React.Component {
  ...
  render() {
    const coverPhoto = this.props.user.cover_photo ? (
    ...
    return (
      <div>
        <div className="cover-photo-container">{coverPhoto}</div>
        {this.props.user.id === this.props.currentUser.id ? (
          <button onClick={this.handleOpenModal} className="cover-pic-btn">
