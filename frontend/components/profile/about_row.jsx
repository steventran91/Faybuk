...
export default class AboutRow extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      data: this.props.user[this.props.type]
  ...
  handleSubmit() {
    this.props
      .updateUser({ id: this.state.id, [this.props.type]: this.state.data })
  ...
  handleDelete() {
    this.props
      .updateUser({ id: this.state.id, [this.props.type]: "" })
  ...
  handleDate(type) {
    let bdayArr = this.state.data.length
        ...
        <div className="about-text">
          <div className="about-birthday">
            <select
              ...
              value={
                this.state.data.length ? this.state.data.split("-")[1] : "0"
              }
            >
              ...
              <option value="03" key="3">
                Mar
              </option>
              <option value="04" key="4">
                Apr
              </option>
              <option value="05" key="5">
                May
              </option>
              <option value="06" key="6">
                Jun
              </option>
              <option value="07" key="7">
                Jul
              </option>
              <option value="08" key="8">
                Aug
              </option>
              <option value="09" key="9">
                Sep
              </option>
            ...
            <select
              ...
              value={
                this.state.data.length
                  ? parseInt(this.state.data.split("-")[2])
                  : "0"
              }
            >
              <option value="0" key="0" disabled>
            ...
            <select
              ...
              value={
                this.state.data.length ? this.state.data.split("-")[0] : "0"
              }
            >
              <option value="0" key="0" disabled>
                Year
          ...
          <div className="about-text-buttons">
            ...
            <button
              ...
              disabled={
                this.state.data.split("-").some((date) => date === "0") ||
                this.state.data === ""
                  ? true
                  : false
              }
