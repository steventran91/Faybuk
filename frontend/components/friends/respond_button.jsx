...
const mDTP = (dispatch, ownProps) => {
  return {
    ...
    delete: (requesterId, requestedId) =>
      dispatch(deleteFriendRequestWithState(requesterId, requestedId)),
    unfriend: (user_id, friend_id) =>
      dispatch(deleteFriendshipWithState(user_id, friend_id)),
  };
};
...
class RespondButton extends React.Component {
  ...
  handleAccept() {
    ...
    this.props.accept(friendship).then(this.setState({ dropwdown: false }));
  }

  handleDelete() {
    this.props
      .delete(this.props.wallUserId, this.props.currentUserId)
      .then(this.setState({ dropdown: false }));
  }

  handleUnfriend() {
    this.props
      .unfriend(this.props.currentUserId, this.props.wallUserId)
      .then(this.setState({ dropdown: false }));
  }
  ...
  render() {
    ...
    return (
      <div className="relative">
        <button
          id={this.props.type === "respond" ? "respond-btn" : ""}
